...
<template>
  <div>
    <div id="AddDiv" class="black_overlay_bg" style="display: none;">
      ...
      <form id="fromUser" class="form-horizontal add-book" style="background-color: white;" role="form">
        <div class="form-group">
          <label class="col-sm-2 control-label text-label">countryCode</label>
          <div class="col-sm-12">
            <input type='text' class="form-control" id="countryCode"
                   placeholder="Please enter countryCode">
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label text-label">userName</label>
          <div class="col-sm-12">
            <input type='text' class="form-control" id="userName"
                   placeholder="Please enter userName">
          </div>
          <label class="col-sm-2 control-label text-label">password</label>
          <div class="col-sm-12">
        ...
        <div class="form-group">
          <div class="col-sm-12">
            <button type="button" class="btn btn-default btn-lg col-sm-2" @click="login">Anonymous</button>
            <button type="button" class="btn btn-default btn-lg col-sm-2" @click="loginByPhone()">Login</button>
            <button type="button" class="btn btn-default btn-lg col-sm-2" @click="cancel">Cancel</button>
          </div>
        </div>
      </form>

      <form id="formUserKey" class="form-horizontal add-book" style="background-color: white;" role="form">
        <div class="form-group">
          <label class="col-sm-2 control-label text-label">userKey</label>
          <div class="col-sm-12">
            <input type='text' class="form-control" id="userKey"
                   placeholder="Please enter userKey">
          </div>
          <label class="col-sm-2 control-label text-label">userReKey</label>
          <div class="col-sm-12">
            <input type='text' class="form-control" id="userReKey"
                   placeholder="Please enter userReKey">
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-12">
            <button type="button" class="btn btn-default btn-lg col-sm-2" @click="setUserkey">enter</button>
            <button type="button" class="btn btn-default btn-lg col-sm-2" @click="cancel">Cancel</button>
          </div>
        </div>
      </form>

      <form id="fromCloudZone" class="form-horizontal add-book" style="background-color: white;" role="form">
        <div class="form-group">
          <label class="col-sm-2 control-label text-label">OpenZone</label>
          <div class="col-sm-12">
            <input type='text' class="form-control" id="zoneName"
                   placeholder="Please enter zoneName">
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-12">
            <button type="button" class="btn btn-default btn-lg col-sm-2" @click="openZone">enter</button>
            <button type="button" class="btn btn-default btn-lg col-sm-2" @click="cancel">Cancel</button>
          </div>
        </div>
      </form>
      ...
      <form id="formAdd" class="form-horizontal add-book" style="background-color: white;" role="form">
        <div class="form-group" style="alignment: center;">
          <p v-if="!isEdit" class="bookActionTitle">Add Book</p>
          <p v-else class="bookActionTitle">Edit Book</p>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-sm-12">
            <button v-if="!isEdit" type="button" class="btn btn-default btn-lg col-sm-6" @click="addNewData">Add
            </button>
            <button v-else type="button" class="btn btn-default btn-lg col-sm-6" @click="addNewData">Confirm</button>
    ...
    <div class="header">
      ...
      <img src="../assets/DB.svg" class="btn-image" @click="showZone">
      <img src="../assets/userKey.svg" class="btn-image" @click="showUserKey">
      <img src="../assets/mine.svg" class="btn-image loginImage" @click="showLogin">
    </div>
    <table id="list-table" class="table" style="margin-left: 40px;">
      ...
      <tr>
        <th>
          <button class="btn" @click="orderBy('id')">id</button>
        </th>
        <th>
